    ...
    <nav className="navbar glass-navbar">
      <div className="navbar-container">
        <div className="navbar-logo">
          {/* <img src={logo} alt="Moody Player Logo" className="logo-icon" /> */}
          <svg
          className="logo-svg"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="32px" /* Or just force the size here directly */
    height="32px"
          ...
          <div className="logo-text">
            <h1 className="caveat-unique logo-title">Moodify</h1>
            <span className="logo-subtitle caveat-unique">
